...
function setup(partyid) {
	...
	var instanceName = "BossQuestHard" + partyid;
...
function allMonstersDead(eim) {
	...
	if (0 - monster_time <= 0) points += (2 * (monster_number + 1));
	else points += (2 * (monster_number + 1));
...
function monsterSpawn(eim) {
	...
	else overrideStats.setHp(mob.getHp() * 3);
