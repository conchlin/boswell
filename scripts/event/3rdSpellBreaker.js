...
var exitMap = 211060600;
var eventMap = 211060601;

function init(){}

function setup(difficulty, lobbyId){
	var eim = em.newInstance("3rdSpellBreaker_" +lobbyId);
...
function playerEntry(eim, player){
	...
	player.getClient().announce(MaplePacketCreator.earnTitleMessage("Defeat the Blue Prison Rhinos to break the third magic ward of the Lion King's Castle!"));
}
