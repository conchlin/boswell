...
function setEventRewards(eim) {
        var expStages;
        expStages = [4800];    //bonus exp given on CLEAR stage signal
...
function bunnyDefeated(eim) {
        eim.dropMessage(5, "Due to your failure to protect the Moon Bunny, you have been transported from Primrose Hill.");
        end(eim);
}
