...
def ret = npc.askYesNo(user.getMapId() == 260020000 ? toMagatia : toAriant)

if (ret == 1) {
    if (user.getMeso() < 1500) {
        npc.say("I am sorry, but I think you are short on mesos. I am afraid I can't let you ride this if you do " +
    ...
    npc.say("Hmmm... too busy to do it right now? If you feel like doing it, though, come back and find me.")
}