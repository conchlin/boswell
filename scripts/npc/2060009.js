...
function start() { // no gspq
    if(cm.isQuestStarted(3845)) {
        cm.forceCompleteQuest(3845);
        cm.gainExp(50000);
        cm.sendOk("The Sea of Fog? I've heard dangerous tales about that place. There aren't enough mesos in the " +
            "world to get me to bring you there. Tough luck!")
        cm.dispose();
        return;
    }
    ...
    cm.sendSimple ("Ocean are all connected to each other. Place you can't reach by foot can easily reached oversea. " +
