...
function action(mode, type, selection) {
    if (mode < 1) {
        ...
        if (mode === 1)
            ...
            status--;
        if (status === 0) {
            cm.sendSimple("Hello, I'm Dr. Rhomes, head of the cosmetic lens department here at the Orbis Plastic " +
                "Surgery Shop.\r\nMy goal here is to add personality to everyone's eyes through the wonders of " +
                "cosmetic lenses, and with #b#t5152011##k or #b#t5152014##k, I can do the same for you, too! " +
            ...
            if (selection === 1) {
                ...
                cm.sendYesNo("If you use the regular coupon, you'll be awarded a random pair of cosmetic lenses. " +
                    "Are you going to use a #b#t5152011##k and really make the change to your eyes?");
            } else if (selection === 2) {
                beauty = 2;
                var current = getFace();
                colors = Array();
