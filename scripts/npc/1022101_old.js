    ...
    if (mode < 0)
        ...
        if (status == 0 && mode == 1) {
			...
			if(choice == 0) {
				...
				if(!cm.getPlayer().getInventory(Packages.client.inventory.InventoryType.SETUP).isFull(chairAmount)) {
				...
				if(!cm.getPlayer().getInventory(Packages.client.inventory.InventoryType.EQUIP).isFull(weaponAmount)) {
				...
				if(!cm.getPlayer().getInventory(Packages.client.inventory.InventoryType.USE).isFull(2)) {
				...
				if(!cm.haveItem(5030000, 1)) {
					if(!cm.getPlayer().getInventory(Packages.client.inventory.InventoryType.CASH).isFull(1)){
