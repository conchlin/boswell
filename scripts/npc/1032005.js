...
function action(mode, type, selection) {
    ...
    if (mode == -1){
        ...
        cm.sendOk("This town also has a lot to offer. " +
            "Find us if and when you feel the need to go to the Ant Tunnel Park.");
    	cm.dispose();
    	return;
    }
    if (status == 1) {
        cm.sendYesNo(beginner ? "We have a special 90% discount for beginners. " +
