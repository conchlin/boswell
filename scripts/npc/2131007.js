    ...
    if (status == 0) {
    	...
    	if (status == 1) {
			...
			if (!cm.haveItem(exchangeItem, 100)) {
				...
				cm.sendGetNumber("Hey, that's a good idea! I can give you #i4310000#Perfect Pitch for each 100 #i" +
					exchangeItem + "##t" + exchangeItem + "# you give me. How many do you want? (Current Items: " +
					cm.itemQuantity(exchangeItem) + ")", java.lang.Math.min(300.0, cm.itemQuantity(exchangeItem) / 100), 1,
					java.lang.Math.min(300.0, cm.itemQuantity(exchangeItem) / 100));
			}
		} else {
