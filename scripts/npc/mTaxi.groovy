...
script.sayNext("Hi there! This cab is for VIP customers only. Instead of just taking you to different towns " +
...
def ret = script.askYesNo(beginner ? "We have a special 90% discount for beginners. " +
...
if (ret == 1) {
    if (user.getMeso() < cost) {
        script.say("It looks like you don't have enough mesos. Sorry but you won't be able to use this without it.")
    } else {
