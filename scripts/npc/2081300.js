        ...
        if (mode == -1) {
                ...
                if(status == 0) {
                        ...
                        if (mode >= 1 && cm.getJobId() % 100 % 10 != 2) {
                            ...
                            if(cm.getJobId() == 312) {
                                if(cm.getPlayer().getSkillLevel(3120005) == 0) cm.teachSkill(3120005, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3121003) == 0) cm.teachSkill(3121003, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3121006) == 0) cm.teachSkill(3121006, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3121007) == 0) cm.teachSkill(3121007, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3121008) == 0) cm.teachSkill(3121008, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3121009) == 0) cm.teachSkill(3121009, 0, 10, -1);
                            } else if(cm.getJobId() == 322) {
                                if(cm.getPlayer().getSkillLevel(3220004) == 0) cm.teachSkill(3220004, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3221001) == 0) cm.teachSkill(3221001, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3221003) == 0) cm.teachSkill(3221003, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3221005) == 0) cm.teachSkill(3221005, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3221006) == 0) cm.teachSkill(3221006, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(3221008) == 0) cm.teachSkill(3221008, 0, 10, -1);
                            }
