        ...
        if (mode == -1) {
                ...
                if(status == 0) {
                        ...
                        if (mode >= 1 && cm.getJobId() % 100 % 10 != 2) {
                            ...
                            if(cm.getJobId() == 412) {
                                if(cm.getPlayer().getSkillLevel(4120002) == 0) cm.teachSkill(4120002, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4120005) == 0) cm.teachSkill(4120005, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4120003) == 0) cm.teachSkill(4120003, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4120004) == 0) cm.teachSkill(4120004, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4120008) == 0) cm.teachSkill(4120008, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4120009) == 0) cm.teachSkill(4120009, 0, 10, -1);
                            } else if(cm.getJobId() == 422) {
                                if(cm.getPlayer().getSkillLevel(4220002) == 0) cm.teachSkill(4220002, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4220005) == 0) cm.teachSkill(4220005, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4221001) == 0) cm.teachSkill(4221001, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4221003) == 0) cm.teachSkill(4221003, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4221004) == 0) cm.teachSkill(4221004, 0, 10, -1);
                                if(cm.getPlayer().getSkillLevel(4221008) == 0) cm.teachSkill(4221008, 0, 10, -1);
                            }
