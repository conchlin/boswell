...
function action(mode, type, selection) {
    if (mode < 1) {
        ...
        if (mode === 1)
            ...
            status--;
        if (status === 0) {
            cm.sendSimple("Hey, I'm Pata, and I am a renowned plastic surgeon and cosmetic lens expert here in " +
                "Mu Lung. I believe your face and eyes are the most important features in your body, and with " +
                "#b#t5152028##k or #b#t5152041##k, I can prescribe the right kind of facial care and cosmetic " +
                "lenses for you. Now, what would you like to use?\r\n#L1#Plastic Surgery: #i5152028##t5152028##l" +
            ...
            if (selection === 1) {
                ...
                cm.sendStyle("I can totally transform your face into something new... how about giving us a try? " +
                    "For #b#t5152028##k, you can get the face of your liking..." +
                    "take your time in choosing the face of your preference.", facenew);
            } else if (selection === 2) {
                beauty = 2;
                var current = getFace();
                colors = Array();
                pushIfItemsExists(colors, [current, current + 100, current + 300, current + 500, current + 600, current + 700]);
                cm.sendStyle("With our new computer program, you can see yourself after the treatment in advance. " +
                    "What kind of lens would you like to wear? Please choose the style of your liking.", colors);
            } else if (selection === 3) {
                beauty = 3;
                var current = getFace();
                colors = Array();
            ...
            if (beauty === 1) {
                if (cm.haveItem(5152028)) {
                    ...
                    cm.sendOk("I'm sorry, but I don't think you have our plastic surgery coupon with you right now. " +
