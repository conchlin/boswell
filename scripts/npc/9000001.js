/* Jean
	Event NPC
	located in Lith Harbor, Boat Quay
*/
...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			cm.sendNext("Hi! I'm #e#bJean#k#n. Welcome to the #e#bBoss Quest - Normal Mode#k#n!");
		} else if (status == 1) {
			chosen = 0;
			cm.sendSimple("What would you like to do? #e#b\r\n#L0#Begin the Boss Quest - Normal#l\r\n#L1#Trade your Boss Quest Points#l \r\n#L2#Check my Boss Quest Runs#k#n");
		} else if (status == 2) {
			if (selection == 0) {
				if (cm.getParty() == null) {
