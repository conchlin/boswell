...
private void goTown(String fieldName, int fieldID, int fee) {
    def ret = script.askYesNo("You don't have anything else to do here, right? Would you like to go to #b" + fieldName + "#k? " +
            "It will cost #b" + fee + " mesos#k.")
    if (ret == 1) { //yes
        if (user.getMeso() < fee) {
            script.say("You don't have enough money. Without enough money, you won't be able to ride the taxi.")
        } else {
            user.changeMap(fieldID, 0)
        }
    } else {
        script.say("There's a lot to see in this city. Come back and look for us when you need to go somewhere else.")
    }
}

script.sayNext("Do you wanna head over to some other town? With a little money involved, I can make it happen. It's a tad " +
...
if (sel == 0) {
    def sel2 = script.askMenu("There are 6 big towns here in Victoria Island. Which of those do you want to know more of?" +
            "\r\n#b#L0#Lith Harbor#l\r\n#L1#Perion#l\r\n#L2#Ellinia#l\r\n#L3#Henesys#l\r\n#L4#Kerning City#l\r\n#L5#Nautilus Harbor#l\r\n#L6#Sleepywood#l")
    if (sel2 == 0) {
        script.sayNext("The town you are at is Lith Harbor! Alright I'll explain to you more about #bLith Harbor#k. " +
        ...
        script.sayNext("It's a quiet town with the wide body of water on the back of it, thanks to the fact that the " +
        ...
        script.sayNext("Around town lies a beautiful prairie. Most of the monsters there are small and gentle, " +
                "perfect for beginners. If you haven't chosen your job yet, this is a good place to boost up your level.")
    } else if (sel2 == 1) {
        script.sayNext("Alright I'll explain to you more about #bPerion#k. It's a warrior-town located at the " +
        ...
        script.sayNext("Around the highland you'll find a really skinny tree, a wild hog running around the place, and " +
                ...
                "or don't go at all.")
        script.sayNext("If you want to be a the #bWarrior#k then find #r#p1022000##k, the chief of Perion. If you're " +
        ...
        script.sayNext("Alright I'll explain to you more about #bEllinia#k. It's a magician-town located at the fart east " +
        ...
        script.sayNext("Near the forest you'll find green slimes, walking mushrooms, monkeys and zombie monkeys all " +
        ...
        script.sayNext("If you want to be the #bMagician#k, search for #r#p1032001##k, the head wizard of Ellinia. He may " +
        ...
        script.sayNext("If you want to be the #bBowman#k, you need to go see #r#p1012100##k at Henesys. With a level " +
        ...
        script.sayNext("Alright I'll explain to you more about #bKerning City#k. It's a thief-town located at the " +
        ...
        script.sayNext("From Kerning City, you can go into several dungeons. You can go to a swamp where alligators " +
        ...
        script.sayNext("If you want to be the #bThief#k, seek #r#p1052001##k, the heart of darkness of Kerning City. " +
        ...
        script.sayNext("Here's a little information on #b#m120000000##k. It's a submarine that's currently parked in " +
        ...
        script.sendNext("#m120000000# is parked in between Henesys and Ellinia, so if you step out just a bit, you'll " +
                "be able to enjoy the view of both towns. All the pirates you'll meet in town are very gregarious and friendly as well.")
        script.sendNext("If you are serious about becoming a #bPirate#k, then you better meet the captain of " +
        ...
        script.sayNext("Alright I'll explain to you more about #bSleepywood#k. It's a forest town located at the southeast " +
        ...
        script.sayNext("In front of the hotel there's an old buddhist monk by the name of #r#p1061000##k. Nobody knows " +
        ...
        script.sayNext("From Sleepywood, head east and you'll find the ant tunnel connected to the deepest part of the " +
        ...
        script.sayNext("And this is what I hear ... apparently, at Sleepywood there's a secret entrance leading you " +
    ...
    def sel3 = script.askMenu(menu + menu1)
