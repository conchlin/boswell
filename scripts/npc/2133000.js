                ...
                if (status == 0) {
                        ...
                        if (selection == 0) {
                                if (!cm.haveItem(1032060) && cm.haveItem(4001198, 15)) {
                                        ...
                                        cm.sendOk("You either have Altair Earrings already or you do not have 15 Altair Fragments.");
                                        cm.dispose();
                                }
                        } else if (selection == 1){
                                if (cm.haveItem(1032060) && !cm.haveItem(1032061) && cm.haveItem(4001198, 15)) {
                                        cm.gainItem(1032060,-1);
                                        cm.gainItem(1032061, 1);
                                        cm.gainItem(4001198, -15);
                                        cm.dispose();
                                } else {
                                       cm.sendOk("You either don't have Altair Earrings already or you do not have 15 Altair Fragments.");
                                       cm.dispose();
                                }
                        } 
                }
