    ...
    public void sessionOpened(IoSession session) {
        ...
        try {
            ...
            if (remoteHost == null) {
                ...
                NullPointerException npe) {    // thanks Agassy, Alchemist for pointing out possibility of remoteHost = null.
            remoteHost = "null";
        }
        ...
        ClientEncryption sendCypher = new ClientEncryption(ivSend, (short) (0xFFFF - ServerConstants.VERSION));
        ClientEncryption receiveCypher = new ClientEncryption(ivRecv, ServerConstants.VERSION);
        MapleClient client = new MapleClient(sendCypher, receiveCypher, session);
    ...
    public void messageReceived(IoSession session, Object message) {
        ...
        if (packetHandler != null && packetHandler.validateState(client)) {
            try {
                ...
                //client.announce(WvsContext.Packet.enableActions());//bugs sometimes
            }
        }
    }
