...
public class MapleTrade {
    ...
    public static void inviteTrade(MapleCharacter c1, MapleCharacter c2) {
        ...
        if (c1.getMapId() >= 910000001 && c1.getMapId() <= 910000022) {
            c1.message("You cannot trade near Free Market storefronts. " +
                    "Exit to the Free Market before initiating a trade.");
            return;
        }
