...
public class SkillFactory {
    ...
    private static Map<Integer, PlayerSkill> skills = new HashMap<>();
    ...
    private static MapleDataProvider delaySource = MapleDataProviderFactory.getDataProvider(MapleDataProviderFactory.fileInWZPath("Character.wz"));

    public static PlayerSkill getSkill(int id) {
        if (!skills.isEmpty()) {
                    ...
                    if (data.getName().equals("skill")) {
                        for (MapleData data2 : data) { // Loop thru each jobs
                            if (data2 != null) {
                                ...
                                skills.put(skillid, loadFromData(skillid, data2, delayData));
                            }
                        }
                    }
                }
    ...
    private static PlayerSkill loadFromData(int id, MapleData data, MapleData delayData) {
        ...
        MapleData invisible = data.getChildByPath("invisible");
        if (invisible != null) {
        	ret.invisible = true;
        }
