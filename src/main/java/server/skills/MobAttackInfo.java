...
public class MobAttackInfo {
    ...
    private int mpCon;
	private boolean angerAttack;
	private int speakProb;
	private int phrase;
	...
	public boolean isAngerAttack() {
		return angerAttack;
	}

	public void setAngerAttack(boolean angerAttack) {
		this.angerAttack = angerAttack;
	}

	public int getSpeakProb() {
		return speakProb;
	}

	public void setSpeakProb(int speakProb) {
		this.speakProb = speakProb;
	}
	...
	public void setPhrases(int phrase) {
		this.phrase = phrase;
	}
